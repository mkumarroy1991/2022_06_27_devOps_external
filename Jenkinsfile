    ...
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'master',
                    url: 'https://github.com/mkumarroy1991/2022_06_27_devOps_external.git'
        ...
        stage('Push Image') {
         ...
         stage('deploy to k8s') {
            ...
            steps {
                ...
                sh "kubectl set image deployment/demo-node-external-deployment demo-node-external=${env.imageName}:${env.BUILD_ID} -n demo"
